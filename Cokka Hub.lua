...
spawn(function()
loadstring(game:HttpGet("https://pastebin.com/raw/7sCPqTCR"))()
end)
...
setclipboard("https://discord.gg/yn8cF6sqcN")
end)
L_35_.Info:Button("My Youtube (Click Copy)", function()
setclipboard("https://www.youtube.com/wat")
end)
...
Notify("<Color=White>Script is finally cracked<Color=/>", 10)
Notify("<Color=Blue>Enjoy keyless :)<Color=/>", 8)
